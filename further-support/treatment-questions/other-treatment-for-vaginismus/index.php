<?php
  $pagetitle = 'Are there any drugs, vitamins, magnets or surgical procedures available to cure vaginismus?';
  $pagedescription = 'Are there any drugs, vitamins, magnets or surgical procedures available to cure vaginismus? There are no drugs, vitamins, magnets or surgical procedures that cure vaginismus.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/treatment-questions/other-treatment-for-vaginismus/';
...
<!--   MAIN SECTION   -->
        <section class="large-9">
          ...
          <h3>Surgeries</h3>
          <p>In rare cases, some women may have an unusually thick hymen and may need to have a hymenectomy (a minor surgical procedure to remove the hymen) but there is no surgery to cure vaginismus.</p>
