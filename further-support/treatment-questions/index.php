<?php
  $pagetitle = 'Treatment FAQ';
  $pagedescription = 'Frequently asked questions about treating vaginismus';
  $pagecanonical = 'https://www.vaginismus.com/further-support/treatment-questions/';
