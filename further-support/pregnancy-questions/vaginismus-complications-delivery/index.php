<?php
  $pagetitle = 'Will vaginismus cause complications impede vaginal delivery of a baby? Will the pelvic floor muscles spasm or cause problems?';
  $pagedescription = 'Unresolved vaginismus may present some challenges during pregnancy, but will not normally impede the actual vaginal delivery process.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/pregnancy-questions/vaginismus-complications-delivery/';
...
<!--   FAQ BODY   -->
      ...
      <?php
        $active = 'complications';  include(ROOT_PATH.'/includes/sidebar-pregnancy-faq.php');
      ?>
        <section class="">
          <h1>Will vaginismus cause complications or impede vaginal delivery of a baby? Will the pelvic floor muscles spasm or cause problems?</h1>
                
          <h3>Unresolved vaginismus may present some challenges during pregnancy, but will not normally impede the actual vaginal delivery process.</h3>
          <p>During the birthing process, hormones are activated that cause a women’s cervix and vaginal canal to involuntarily dilate (widen or expand) and automatically proceed, ignoring vaginismus impulses should they be present.</p>
