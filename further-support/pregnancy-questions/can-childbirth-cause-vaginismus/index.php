<?php
  $pagetitle = 'Can childbirth cause vaginismus? Can it be prevented?';
  $pagedescription = 'The temporary pains of childbirth can trigger ongoing vaginismus sexual pain.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/pregnancy-questions/can-childbirth-cause-vaginismus/';
    ...
    <div class="wrapper faq-body">
      ...
      ?>
        <section class="" id="question-answered">
          ...
          <ul>
            <li>To reduce potential emotional trauma from delivery, combat any fears regarding the birthing process with facts. Discuss fears or concerns with midwives, nurses, or physicians. Become educated and knowledgeable about the birthing process.</li>
            <li>To help reduce any unbalanced anxieties or &#8220;anticipation of pain&#8221; fears, avoid listening to or focusing on difficult birth stories. Most women have positive birth experiences. If fears of delivery pain loom large, remember that epidurals and other pain relief medical interventions are usually available if desired. Discuss pain management strategies as part of your birth plan.</li>
            <li>Keep a positive mind-set and attitude. Thoughts like &#8220;Women give birth everyday&#8221; and &#8220;If they can do it, I can do it!&#8221; help allay negative thinking.</li>
            <li>Unless a physician has advised otherwise, continue having sex throughout the pregnancy.</li>
            <li>Post-partum, wait 6 weeks as recommended by most physicians to resume intercourse—this is important as it allows the vaginal canal to heal so that no physical pain is initially experienced in the transition back to intercourse following delivery.</li>
            <li>Take things slowly—first time sex after delivery should be relaxed with slow movements.</li>
            <li>Lubricate heavily as there are often hormonal changes post-pregnancy especially when nursing, which can cause vaginal dryness.</li>
            <li>Do not be surprised if sex initially seems different than before. Emotional stress and fatigue brought on by demands of parenting along with hormone fluctuations can make a woman feel less than sensuous. Also, making the transition from being a mommy to being a lover may take some adjustment.</li>
            <li>See a physician immediately if there is any post-delivery pelvic pain to avoid triggering vaginismus. There may be the possibility of infection, or some other problem that could be easily resolved without long-term effect.</li>
          </ul>
