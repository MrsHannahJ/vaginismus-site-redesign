<?php
  $pagetitle = 'Can the dilators be used to treat other conditions besides vaginismus?';
  $pagedescription = 'Can the dilators be used to treat other conditions besides vaginismus? Dilators are successfully used by health professionals to treat a wide variety of medical conditions.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/dilator-questions/dilators-treat-other-conditions/';
