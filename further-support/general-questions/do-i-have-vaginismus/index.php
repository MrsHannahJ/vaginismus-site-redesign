<?php
  $pagetitle = 'How do I know if I have vaginismus?';
  $pagedescription = 'How do I know if I have vaginismus? Women often suspect they have vaginismus simply from their symptoms.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/general-questions/do-i-have-vaginismus/';
...
<!--   MAIN SECTION   -->
        <section class="large-9">
          ...
          <ul>
            ...
            <li>Ongoing sexual discomfort or pain following childbirth, yeast/urinary infections, STDs, IC, hysterectomy, cancer and surgeries, rape, menopause, or other <a href="../../../vaginismus-causes/index.html#non-physical-causes">problems</a></li>
