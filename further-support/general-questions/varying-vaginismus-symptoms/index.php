<?php
  $pagetitle = 'Are there varying degrees of symptoms with vaginismus?';
  ...
  $pagecanonical = 'https://www.vaginismus.com/further-support/general-questions/varying-vaginismus-symptoms/';
  ...
  <?php
    ...
    ?>
        <section class="" id="question-answered">
          ...
          <ul>
            <li>Some experience tightness causing minor burning sensations or stinging during intercourse.</li>
            <li>Some are able to insert a tampon or complete a gynecological exam, yet find intercourse impossible.</li>
            <li>Some are able to partially insert a penis, but the process is painful and difficult.</li>
            <li>Some are able to fully insert a penis, but tightness and discomfort interrupt the normal progression from arousal through to orgasm and bring pain instead. Intercourse is aborted.</li>
            <li>There may be total closure of the vagina making penetration impossible.</li>
            <li>Some women experience spasms in other body muscle groups (legs, lower back, etc.) or halted breathing during attempts at intercourse.</li>
            <li>There may be avoidance of sex or even anything sexual due to pain and failure.</li>
            <li>Minor discomfort or burning with tightness is experienced with vaginal entry or thrusting but may diminish.</li>
            <li>More significant burning and tightness is experienced with vaginal entry or thrusting and tends to persist.</li>
            <li>Involuntary tightness of the vaginal muscles makes entry and movement difficult and painful.</li>
            <li>Partner is unable to penetrate due to tightly closed vaginal opening. If entry is forced significant pain results.</li>
