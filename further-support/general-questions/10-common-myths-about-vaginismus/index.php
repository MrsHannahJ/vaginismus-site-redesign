<?php
  $pagetitle = '10 Common Myths About Vaginismus';
  $pagedescription = 'Find out about the most common vaginismus myths and learn the truth.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/general-questions/10-common-myths-about-vaginismus/';
        ...
        <section class="">
          ...
          <div class="blog-article">
            ...
            <ol class="number-list">
              ...
              <li><strong>My husband/partner is just &#8220;too big&#8221; for me.</strong> Although it may seem a likely reason that intercourse is so difficult is because your husband/partner is well-endowed, penis size usually has nothing to do with vaginismus. With vaginismus the vaginal muscles are tightening up (without your conscious control) so there is not enough room for the penis to enter. No matter the size of an adult woman, the vagina is designed to accommodate a fully erect penis.</li>
              <li><strong>There is no cure for vaginismus.</strong> This statement is completely false. Vaginismus is highly treatable.</li>
              <li><strong>It takes thousands of dollars to overcome vaginismus.</strong> Vaginismus treatment does not need to cost exorbitant amounts of money. We provide effective and reasonably priced resources to women worldwide.</li>
              <li><strong>All women with vaginismus have been sexually abused.</strong> There are many emotional and physical causes for vaginismus and sexual abuse is just one of them. Women who develop vaginismus often have abuse-free backgrounds.</li>
