    ...
    <div class="wrapper faq-body">
      ...
      ?>
        <section class="" id="question-answered">
          ...
          <p>A systematic approach to problems with orgasm is helpful, as there are many reasons why orgasm difficulty could be taking place. Women are encouraged to try to determine the nature of the difficulty with orgasm, if it is related to any emotions, anxiety, physical pain, or medication use. The <a href="/treatment/products/vaginismus-treatment-kit/index.php">self-help</a> sexual history inventory in Step 2 of the vaginismus program may be helpful to identify any specific sexual fears or emotions that could be contributing to the problem.</p>
          ...
          <h3>See Also</h3>
          <ul>
            <li><a href="/further-support/general-questions/had-pleasurable-intercourse-before/index.php" target="_blank">Can my problem still be vaginismus if I&#8217;ve had pleasurable intercourse before and now it hurts?</a></li>
