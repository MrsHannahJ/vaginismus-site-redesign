<?php
  $pagetitle = 'Hymen Issues';
  $pagedescription = 'More information about the hymen and vaginismus.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/related-conditions/hymen-resources/';
