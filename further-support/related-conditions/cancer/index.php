<?php
  $pagetitle = 'Cancer Issues';
  $pagedescription = 'Cancer, and associated symptoms and treatments, may contribute to temporary pain during sex. Like other pain causing conditions, cancer may cause or contribute to problems with vaginismus.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/related-conditions/cancer/';
