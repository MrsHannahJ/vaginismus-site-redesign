<?php
  $pagetitle = 'Vaginal Atrophy';
  $pagedescription = 'We hear from many women who are struggling with painful intercourse. It has been our experience that the number one concern of older women who contact us is painful intercourse related to vaginal atrophy.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/related-conditions/vaginal-atrophy-resources/';
...
?>
        <section class="large-9" id="section-related">
          ...
          <div class="indent">
            <p><strong>Denise </strong>(age 68)</p>
            <p>Truly enjoyed her sexual relationship with her first husband. After he passed away, her sex life disappeared. Now remarried, she was looking forward to reigniting that part of her life. Unfortunately, things are not going well.</p>
            <p><strong>Lee </strong>(age 33)</p>
            <p>Undergoes chemotherapy and radiation for breast cancer. These treatments cause her to enter early menopause. Sex is no longer pleasurable.</p>
            <p><strong>Danielle </strong>(age 54)</p>
            <p>Has been told she better &#8220;use it or lose it.&#8221; But it hurts too much!</p>
          </div>
          <h3>Estrogen 101</h3>
          <p>Estrogen is a group of hormones primarily responsible for “maintaining the collagen, elastic fibers, and vasculature of the reproductive organs and urinary tract that is essential for its structural and functional integrity. It also maintains vaginal PH and moisture levels.&#8221;³ Estrogen is produced in the ovaries, along with progesterone and testosterone.</p>

          <h3>What is Vaginal Atrophy?</h3>
          <p>Vaginal atrophy (atrophic vaginitis) is a medical condition characterized by the inflammation of the vagina due to diminishing estrogen levels and is usually brought on by menopause. It results in thinning and shrinking of the vaginal walls as well as reduced lubrication. The pelvic floor muscles, urethra, and vagina (the entire urogenital tract) may all be affected by the reduction of estrogen production.</p>

          <h3>Symptoms</h3>
          <ul>
            <li>vaginal dryness, itching, burning</li>
            <li>discomfort and/or painful sexual intercourse</li>
            <li>slight spotting/bleeding during intercourse</li>
            <li>thinning pubic hair</li>
            <li>increased frequency of UTIs</li>
            <li>increased vaginal infections</li>
            <li>increased vaginal PH levels</li>
          </ul>

          <h3>When &amp; Why Does This Happen?</h3>
          <p>Vaginal atrophy can develop whenever there is a prolonged reduction in the amount of estrogen a woman’s body produces. This drop in estrogen could be due to the onset of menopause, treatment for cancer, surgical removal of the ovaries, or following giving birth. Although most commonly seen in older women, it does affect younger women as well.</p>

          <h3 id="menopause">Did You Know?</h3>
          <p>Menopause Facts: Defined as 12 months since a woman’s menstrual cycle; average age 51.3 yrs., not a single event, symptoms last on average 3.8 years.<sup>3</sup></p>
          <ul>
            <li>Menopause – Vaginal Atrophy is a common symptom of menopause. It has been estimated that over 50% of menopausal women will develop atrophy.<sup>1</sup> Some estimates are even higher at 75-90%.<sup>2</sup></li>
            <li>Cancer treatments – Cervical, Ovarian, Breast, Uterine
              <ul>
                <li>Both chemotherapy and radiation therapy can cause ovarian failure. With little to no estrogen being produced menopause is brought on. Vaginal atrophy can also be a side effect of treatment for cancers that are not specifically located in the pelvic region.</li>
              </ul>
            </li>
            <li>Surgery &#8211; Surgical removal of the ovaries immediately brings the onset of menopause and can cause vaginal atrophy to develop.</li>
            <li>Childbirth/breast-feeding
              <ul>
                <li>Following childbirth and while breastfeeding some women experience a drop in estrogen levels causing vaginal dryness.</li>
              </ul>
            </li>
          </ul>
          ...
          <ul>
            <li>Has sex become increasingly uncomfortable?</li>
            <li>Does your vagina feel like &#8220;sandpaper&#8221;?</li>
            <li>Do you have vaginal dryness, itching, and/or burning?</li>
            <li>Have you noticed a decrease in your natural lubrication?</li>
            <li>Have pelvic/gynecological exams become uncomfortable?</li>
            <li>Have there been changes in the outer appearance of the vagina? Shrinking folds of skin? Less pubic hair?</li>
            <li>Is there a reason you may be experiencing a drop in estrogen production—approaching menopause, cancer treatment, etc.?</li>
          </ul>
          ...
          <ul>
            ...
            <li><a href="http://www.huffingtonpost.com/marcia-g-yerman/a-new-look-at-the-older-v_b_832261.html" target="_blank">A New Look at the Older Vagina</a></li>
          </ul>
