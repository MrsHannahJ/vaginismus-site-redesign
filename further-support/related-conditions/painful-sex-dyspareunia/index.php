<?php
  $pagetitle = 'Dyspareunia';
  $pagedescription = 'There are many causes of dyspareunia (painful sex). Vaginismus is one type of dyspareunia.';
  $pagecanonical = 'https://www.vaginismus.com/further-support/related-conditions/painful-sex-dyspareunia/';
...
?>
        <section class="large-9" id="section-related">
          ...
          <ol>
            ...
            <li><a href="http://www.nlm.nih.gov/medlineplus/femalesexualdysfunction.html" target="_blank">&#8220;Female Sexual Dysfunction</a>&#8221;</li>
