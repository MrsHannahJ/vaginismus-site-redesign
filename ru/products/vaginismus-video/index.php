<?php
  $pagetitle = 'Вагинизм Лечение обучающее видео';
  $pagedescription = 'Единственное лечение видео в своем роде, Лечение Вагинизм следует пара борется с вагинизма как специалист проводит их через лечение. Этот вымышленный случай фокусируется на правильном применении вагинальных расширителей в качестве компонента решения вагинизм и не должны рассматриваться в качестве полной программы лечения.';
  $pagecanonical = 'https://www.vaginismus.com/ru/products/vaginismus-video/';
...
<!--   HERO SECTION   -->
      <section class="hero grad1">
        <div class="wrapper">
          <h1>Вагинизм Лечение обучающее видео</h1>
          <h3>Единственное лечение видео в своем роде, Лечение Вагинизм следует пара борется с вагинизма как специалист проводит их через лечение</h3>
        </div>
      </section>
