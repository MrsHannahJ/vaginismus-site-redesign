<?php
  $pagetitle = 'Продукты';
  $pagedescription = 'продукты, предлагаемые vaginismus.com';
  $pagecanonical = 'https://www.vaginismus.com/ru/products/';
      ...
      <div class="wrapper">
         <div class="large-12 medium-12">
           <div class="hero-text-right">
             <h1 aria-hidden="true" class="visually-hidden">вагинизм Продукты</h1>
...
<!--      VIDEO SECTION      -->
     ...
     <section class="mission-banner grad1">
       <div class="wrapper">
         <h2>Наша цель</h2>
         <p>Наша цель – оказывать помощь и поддержку женщинам, страдающим вагинизмом,  всеми доступными способами Помимо наших эффективных программ лечения в домашних условиях, мы предлагаем помощь, надежду и бесплатную поддержку женщинам по всему миру.</p>
       </div>
     </section>
