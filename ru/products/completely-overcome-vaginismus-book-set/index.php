<?php
  $pagetitle = 'Книга для лечения вагинизма';
  $pagedescription = 'Это прекрасно иллюстрированное издание, содержащее более 300 страниц, в котором подробно описывается курс лечения вагинизма в домашних условиях. В этой книге представлены все аспекты успешного лечения вагинизма в домашних условиях в доступном формате пошаговой программы лечения.';
  $pagecanonical = 'https://www.vaginismus.com/ru/products/completely-overcome-vaginismus-book-set/';
...
<!--   HERO SECTION   -->
      <section class="hero grad1">
        <div class="wrapper">
          <h1>Книга для лечения вагинизма</h1>
          <h3>Это прекрасно иллюстрированное издание, содержащее более 300 страниц, в котором подробно описывается курс лечения вагинизма в домашних условиях. В этой книге представлены все аспекты успешного лечения вагинизма в домашних условиях в доступном формате пошаговой программы лечения.</h3>
        </div>
      </section>
      ...
      <section class="product-description-0">
        <div class="wrapper">
          ...
          <div class="large-4 medium-4">
            ...
            <ul>
              <li>Простые шаги</li>
              <li>Полезные иллюстрации</li>
              <li>Упражнения и вопросы</li>
              <li>В комплект входит пропуск для участия в форуме</li>
            </ul>
