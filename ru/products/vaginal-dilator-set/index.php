...
<!--  Replace these images with coded text-->
          <div class="large-6 medium-6">
            ...
            <p>Для лечения вагинизма и других подобных заболеваний, связанных с болезненностью или невозможностью осуществления полового акта, мы рекомендуем наш п <a href="../vaginismus-treatment-kit/index.html">олный набор для лечения вагинизма</a>. Показатели эффективности лечения являются наиболее высокими при прохождении профессионально разработанной программы курса лечения.</p>
      ...
      <section class="order-today">
        <div class="wrapper">
          ...
          <div class="large-4 medium-4">
            ...
            <p class="product-price-caption">*Плюс доставка и транспортировка.</p>
            <p><a class="shaded-btn" href="#">Добавить В Корзину</a></p>
            <p><a href="../../reviews/dilator-reviews/index.html">Отзывы клиентов<i class="icon-angle-double-right"></i></a></p>
          </div>
        </div>
      </section>
...
<!--   DILATOR FAQ BANNER   -->
      <section class="treatment-banner grad1">
        ...
        <p><a class="white-btn" href="../../faq/index.html#dilator-faq">Узнать больше</a></p>
      </section>
