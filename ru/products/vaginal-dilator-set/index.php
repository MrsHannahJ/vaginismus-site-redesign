<?php
  $pagetitle = 'Набор вагинальных расширителей';
  $pagedescription = 'Эти расширители гладкие и удобные, легко контролировать, легкий, без латекса, можно стирать и безопасно.';
  $pagecanonical = 'https://www.vaginismus.com/ru/products/vaginal-dilator-set/';
...
<!--   HERO SECTION   -->
      <section class="hero grad1">
        <div class="wrapper">
          <h1>Набор вагинальных расширителей</h1>
          <h3>Отличный продукт: Эти вагинальные расширители отличаются гладкой и мягкой поверхностью, удобством и простотой в использовании, легкостью, отсутствием латекса, гигиеничностью и безопасностью.</h3>
        </div>
      </section>
      ...
      <section class="product-description-0">
        <div class="wrapper">
          <div class="large-8 medium-8">
            <img src="/img/products/products-dilator-set.jpg" alt="Вагинальный расширитель Комплект: 6 расширители, универсальная ручка и сумка для переноски">
          </div>
      ...
      <section class="product-description-3">
        <div class="wrapper">
          ...
          <div class="large-6">
            ...
            <p><strong>ПРИМЕЧАНИЕ:</strong> Наш новый – самый маленький – расширитель по размеру уже обычного тампона. Этот размер идеально подходит для женщин, испытывающих затруднения с введением тампонов, а также способствует оптимально удобному переходу к использованию расширителей большего размера.</p>
          </div>
        </div>
      </section>
...
<!--  Replace these images with coded text-->
          <div class="large-6 medium-6">
            ...
            <h3><strong>Вы испытываете боль при осуществлении полового акта и вагинального проникновения?</strong></h3>
            <p>Для лечения вагинизма и других подобных заболеваний, связанных с болезненностью или невозможностью осуществления полового акта, мы рекомендуем наш п <a href="../vaginismus-treatment-kit/index.php">олный набор для лечения вагинизма</a>. Показатели эффективности лечения являются наиболее высокими при прохождении профессионально разработанной программы курса лечения.</p>
      ...
      <section class="order-today">
        <div class="wrapper">
          <div class="large-4 medium-4">
            ...
            <p>Отличный продукт: Эти вагинальные расширители отличаются гладкой и мягкой поверхностью, удобством и простотой в использовании, легкостью, отсутствием латекса, гигиеничностью и безопасностью.</p>
          </div>
          <div class="large-4 medium-4">
            <img src="/img/products/products-dilator-set.jpg" alt="Vaginal Dilator Set: 6 dilators, universal handle and carrying pouch.">
          </div>
          <div class="large-4 medium-4">
            <p class="product-price">$44.95<sup><span>USD</span></sup></p>
            <p class="product-price-caption">*Плюс доставка и транспортировка.</p>
            <p><a class="shaded-btn" href="#">Добавить В Корзину</a></p>
            <p><a href="/ru/reviews/dilator-reviews/index.php">Отзывы клиентов<i class="icon-angle-double-right"></i></a></p>
          </div>
        </div>
      </section>
...
<!--   DILATOR FAQ BANNER   -->
      <section class="treatment-banner grad1">
        ...
        <p><a class="white-btn" href="/ru/faq/index.php#dilator-faq">Узнать больше</a></p>
      </section>
