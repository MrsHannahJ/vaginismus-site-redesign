<?php
  $pagetitle = 'ЧЗВ заказе а также Вернуть';
  $pagedescription = 'ЧЗВ заказе а также Вернуть';
  $pagecanonical = 'https://www.vaginismus.com/ru/faq/customer-service-questions/ordering-faqs/';
