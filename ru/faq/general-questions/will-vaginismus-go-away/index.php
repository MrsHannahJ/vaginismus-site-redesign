...
<!--   MAIN SECTION   -->
        <section class="large-9">
          ...
          <p>По счастью, лечение вагинизма имеет <a href="/ru/faq/treatment-questions/vaginismus-treatment-success-rates/index.php">высокие показатели эффективности</a>. Полное преодоление вагинизма является, как правило, результатом прохождения полного курса <a href="/ru/vaginismus-treatment/index.php">лечения</a>, с полным восстановлением полноценных и безболезненных половых отношений.</p>
          <hr/>
          <h3>См. также</h3>
          <ul>
            <li><a href="/ru/vaginismus-treatment/index.php">Лечение вагинизма</a></li>
            <li><a href="/ru/faq/treatment-questions/how-long-does-treatment-take/index.php">Насколько эффективно лечение вагинизма?</a></li>
            ...
            <li><a href="/ru/faq/treatment-questions/can-vaginismus-reoccur/index.php">Может ли вагинизм возникнуть повторно после полного его преодоления?</a></li>
          </ul>
...
<!--   SIDEBAR   -->
          ...
          <ul>
            ...
            <li><a href="/ru/faq/general-questions/will-vaginismus-go-away/index.php" class="active"><i class="icon-angle-double-right"></i>Проходит Ли Вагинизм Без Лечения?</a></li>
