...
<!--   MAIN SECTION   -->
        <section class="large-9">
          ...
          <ul>
            ...
            <li>Программа включает в себя курс лечения из <a href="../../../vaginismus-treatment/index.html#ten-steps">10 шагов</a> или этапов лечения, которые посвящены всем основным аспектам лечения вагинизма в домашних условиях (программа, рассчитанная на выполнение в домашних условиях, но позволяющая легко координировать и сочетать самостоятельную работу пациентки и работу врача по ключевым аспектам лечения вагинизма).</li>
            <li>Программа обеспечивает понимание <a href="../vaginismus-treatment-success-rates/index.html">методики эффективного лечения</a>, которая широко применяется медицинскими специалистами.</li>
            <li>Программа обеспечивает полное понимание природы вагинизма, включая <a href="../../../vaginismus-causes/index.html#non-physical-causes">физические и эмоциональные аспекты</a> вагинизма. В частности, упражнения на составление истории эмоциональных аспектов, которые могут являться причинами возникновения вагинизма, помогают женщинам тщательно проработать эти проблемы, уделяя им необходимое время, которым могут не всегда располагать занятые медицинские специалисты.</li>
            ...
            <li><a href="../../../vaginismus-treatment/index.html">Упражнения в рамках курса лечения</a> сопровождаются подробными иллюстрациями и описанием стратегий, позволяющих более глубоко понять природу заболевания и лечение вагинизма.</li>
            <li>Эта информация может помочь женщинам, страдающим вагинизмом, получить правильный <a href="../../../vaginismus-diagnosis/index.html">диагноз</a> и перейти к выполнению программы лечения вагинизма.</li>
          ...
          <p>По вопросам о том, как продукты для лечения вагинизма могут быть использованы врачами и медицинскими специалистами, <a href="../../../contact-us/index.html">свяжитесь с нами</a> напрямую для получения более подробной информации и дальнейшей помощи.</p>
           
          <hr>
          
          <h3>См. также</h3>
            <ul>
              <li><a href="../../../reviews/index.html">Отзывы медицинских специалистов/пользователей</a></li>
...
<!--   SIDEBAR   -->
          ...
          <ul>
            ...
            <li><a href="../../treatment-questions/vaginismus-treatment-professional-program-help/index.html" class="active"><i class="icon-angle-double-right"></i>Я – Медик, Специализирующийся На Лечении Вагинизма; Как Программа Лечения, Представленная На Вебсайте Vaginismus.Com Может Помочь Моим Пациентам?</a></li>
