<?php
  ...
  $pagedescription = 'التعليقات والآراء';
  $pagecanonical = 'https://www.vaginismus.com/ar/reviews/';
      ...
      <div class="wrapper">
         <div class="large-12 medium-12">
           <div class="hero-text-right">
             <h1>التعليقات والآراء</h1>
             <h3>على مر السنين، جمعنا مجموعة من رسائل التعليقات، ويشتمل العديد منها على قصص شخصية لنساء تغلبن على التشنج المهبلي بمساعدة مواردنا. تم حذف الأسماء والمعلومات التي تدل على الهوية لدواعي الخصوصية (باستثناء التعليقات الطبية/المتخصصة). إلى جانب هذا، للحفاظ على مضمون الرسالة، تم بعض التحرير الطفيف. شكراً للجميع على تعليقاتكم!</h3>
           </div>
        </div>
      </div>
    </section>
