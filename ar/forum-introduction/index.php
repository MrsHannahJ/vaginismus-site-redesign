<?php
  $pagetitle = 'المنتدى';
  $pagedescription = 'المنتدى';
  $pagecanonical = 'https://www.vaginismus.com/ar/forum-introduction/';
      ...
      <div class="wrapper">
        <div class="large-12 medium-12">
          <div class="hero-text-right">
            <h1>انضمي لآلاف السيدات اللاتي يساعدن بعضهن البعض على التحسن</h1>
            <h3>احصلي على الصداقة، والدعم، والشفاء في منتديات التشنج المهبلي الخاصة، والتي بها الآلاف من العضوات من كافة أرجاء العالم –  وهي في زيادة مستمرة.</h3>
            <h2>الدخول</h2>
<!--    NEED TO REWORK FORM    -->
            <form title="ادخل اسم المستخدم وكلمة المرور للدخول إلى المهبل المنتديات الخاصة" action="http://www.vaginismus.com/forum/ucp.php?mode=login" method="post" >
            <div id="forum_login">
              <p>اسم المستخدم:</p>
              <input id="username" class="field" maxlength="40" name="username" type="text" value="" />
            </div>
            <div id="fpw">
              <p>كلمة المرور: <a href="http://www.vaginismus.com/forum/ucp.php?mode=sendpassword">نسيتها?</a></p>
              <input id="password" class="field" maxlength="32" name="password" type="password" value="" />
              <input name="login" type="submit" value="الدخول" />
...
<!--      NETWORK OF SUPPORT SECTION      -->
    ...
    <section class="forum-testimonials">
      <h2>شبكة الدعم مع تشجيع و ريال مدريد أجوبة</h2>
      <div class="wrapper">
        <div class="large-4">
          ...
          <ul>
            ...
            <li>المسائل الدينية والاجتماعية المتعلقة بالتشنج المهبلي</li>
            <li>قصص النجاح</li>
            <li>مشكلات الاختبارات النسائية</li>
            <li>الانتقال إلى جماع خال من الألم</li>
          </ul>
        </div>
        <div class="large-4">
    ...
    <section class="spouses-allowed">
      <div class="wrapper">
        <div class="large-6 opaque-box">
          <h2>هل يسمح بالأزواج؟</h2>
          <p>نعم، يسمح للأزواج. غالباً ما يكون من المفيد للأزواج أن يتعرفوا على التشنج المهبلي، وأن يكون لديهم مكان لطرح الأسئلة والحصول على الدعم عند الحاجة. ولقد خصصنا منطقة خاصة من المنتدى للأزواج حيث يحصلوا على الدعم أيضاً.</p>
          <p>ملاحظة: يلزم للأزواج أن يكون لديهم عنوان بريد إلكتروني منفصل لوضع اسم مستخدم. (لا يمكن وضع اسمي مستخدم بنفس عنوان البريد الإلكتروني). بالإضافة إلى هذا، يجب أن يلاحظ الأزواج أنهم بحاجة لأن يتبعوا قواعد المنتدى بشأن الموضوعات المقبولة.</p>
        </div>
      </div>
    </section>
