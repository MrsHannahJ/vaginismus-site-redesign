<?php
  $pagetitle = 'مجموعة الموسعات المهبلية';
  $pagedescription = 'منتج أفضل ببساطة: الموسعات سلسلة ومريحة، وسهلة التحكم، وخفيفة، وخالية من اللاتكس، وقابلة للغسيل، وآمنة.';
  $pagecanonical = 'https://www.vaginismus.com/ar/products/vaginal-dilator-set/';
...
<!--   HERO SECTION   -->
      <section class="hero grad1">
        <div class="wrapper">
          <h1>مجموعة الموسعات المهبلية</h1>
          <h3>منتج أفضل ببساطة: الموسعات سلسلة ومريحة، وسهلة التحكم، وخفيفة، وخالية من اللاتكس، وقابلة للغسيل، وآمنة.</h3>
        </div>
      </section>
        ...
        <div class="wrapper">
          ...
          <div class="large-4 medium-4">
            <div class="price-box">
              <h2>تشتمل:</h2>
              <ul>
                <li>أحجام متدرجة بمقبض قوي</li>
                <li>بلاستيك ناعم ومريح من نوعية طبية</li>
                <li>خال من بي بي أيه، اللاتكس، و الفثالات</li>
                <li>مصنع في الولايات المتحدة الأمريكية</li>
                <li>تصميم في انتظار براءة الاختراع</li>
              </ul>
