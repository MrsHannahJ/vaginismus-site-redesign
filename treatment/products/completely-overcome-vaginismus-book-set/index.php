<?php
  $pagetitle = 'Vaginismus Home Treatment Program';
  $pagedescription = 'This well-illustrated book set comes with over 300 pages detailing the professional self-treatment of vaginismus, covering all aspects of successful home treatment in a simple, step-by-step format.';
  $pagecanonical = 'https://www.vaginismus.com/treatment/products/completely-overcome-vaginismus-book-set/';
  $pageimagepath ="https://www.vaginismus.com/img/products/products-books.jpg";
  include('../../../config.php');
