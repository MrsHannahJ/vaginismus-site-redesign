    ...
    <section class="product-preview">
      <div class="wrapper">
        ...
        <div class="large-4 medium-4">
          ...
          <a class="gray-btn" href="/treatment/products/vaginismus-treatment-kit/index.php">View Product</a>
        </div>
      </div>
    </section>
    ...
    <section class="product-preview">
      <div class="wrapper">
        ...
        <div class="large-4 medium-4">
          ...
          <a class="gray-btn" href="/treatment/products/vaginal-dilator-set/index.php">View Product</a>
        </div>
      </div>
    </section>
    ...
    <section class="product-preview">
      <div class="wrapper">
        ...
        <div class="large-4 medium-4">
          ...
          <a class="gray-btn" href="/treatment/products/completely-overcome-vaginismus-book-set/index.php">View Product</a>
        </div>
    ...
    <section class="product-preview">
      <div class="wrapper">
        ...
        <div class="large-4 medium-4">
          ...
          <a class="gray-btn" href="/treatment/products/vaginismus-video/index.php">View Product</a>
        </div>
      </div>
    </section>
