<?php
  $pagetitle = 'Products';
  $pagedescription = 'Vaginismus treatment products offered by vaginismus.com.';
  $pagecanonical = 'https://www.vaginismus.com/treatment/products/';
     ...
     <section class="product-kit">
       <div class="wrapper">
         ...
         <div class="large-4 medium-4">
           ...
           <p class="product-sku">#K2201-DVD</p>
           ...
           <a class="brand-btn" href="vaginismus-treatment-kit/index.html">View Product</a>
         </div>
       </div>
     </section>
     ...
     <section class="product-dilators">
       <div class="wrapper">
         ...
         <div class="large-4 medium-4">
           ...
           <a class="brand-btn" href="vaginal-dilator-set/index.html">View Product</a>
         </div>
       </div>
     </section>
     ...
     <section class="product-books">
       <div class="wrapper">
         ...
         <div class="large-4 medium-4">
           ...
           <a class="brand-btn" href="completely-overcome-vaginismus-book-set/index.html">View Product</a>
         </div>
...
<!--      VIDEO SECTION      -->
     ...
     <section class="mission-banner grad1">
       <div class="wrapper">
         <h2>Our Mission</h2>
         <p>Our mission is to empower women with vaginismus <em>in any way we can</em>. Going beyond our premier self-help programs, we foster help and hope by providing free support to women throughout the world.</p>
       </div>
     </section>
...
<!--      PRE-FOOTER-BADGES SECTION      -->
      ...
      <div class="pre-footer-badges">
        <div class="wrapper">
          ...
          <div class="large-3 medium-6">
            <div class="badge-box">
              <img src="/img/products/products-shield-icon.png" alt="security icon">
              <hr>
              <ul>
