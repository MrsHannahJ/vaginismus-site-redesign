<?php
  $pagetitle = 'Self-Help Program';
  $pagedescription = 'Vaginismus is considered one of the most successfully treatable female sexual disorders. There is hope!';
  $pagecanonical = 'https://www.vaginismus.com/treatment/self-help-program';
...
<section id="treatment-overview">
  <div class="wrapper">
    ...
    <div class="large-4">
      <p>Vaginismus is highly treatable. Successful vaginismus treatment does not require drugs, surgery, hypnosis, nor any other complex invasive technique. Effective treatment approaches combine pelvic floor control exercises, insertion or dilation training, pain elimination techniques, transition steps, and exercises designed to help women identify, express and resolve any contributing emotional components.</p>
      <p><strong>Treatment steps can often be completed at home</strong>, allowing a woman to work at her own pace in privacy, or in cooperation with her health care provider.</p>
    </div>
    <div class="large-4">
      <ul>
...
-->
      ...
      <div class="wrapper">
        <div class="large-6">
          <div class="opaque-box">
            ...
            <p>Many of the steps to treat vaginismus are counter-intuitive and not immediately obvious. As failure at any point inhibits recovery (experiencing discomfort tends to intensify vaginismus—see <a href="/what-is-vaginismus/vaginismus-causes/index.php#cycle-pain">Cycle of Pain</a>) and can cause avoidance or abandonment of progress, it is best to approach vaginismus with an educated understanding to ensure success in dealing with it.</p>
          </div>
        </div>
        <div class="large-6">
          <div class="opaque-box">
            ...
            <p>The sexual pain, tightness, burning or penetration difficulties caused by vaginismus are completely treatable, with high <a href="/further-support/treatment-questions/vaginismus-treatment-success-rates/index.php">success rates</a> for treatment. Couples are often amazed by the sudden life-changing effects of treatment. Those with penetration difficulties, or pain during intercourse, normally transition to pain-free and pleasurable intercourse following a step-by-step approach.</p>
          </div>
        </div>
      </div>
      <div class="wrapper">
        <div class="large-6">
          <div class="opaque-box">
            ...
            <p>Note that treatment for those who have never been able to have pain-free intercourse (primary vaginismus) usually requires all 10 steps, while those with secondary vaginismus may be able to shorten or bypass some steps (see also <a href="/further-support/treatment-questions/treatment-for-primary-and-secondary-vaginismus/index.php">Is there a difference between the treatment for primary and secondary vaginismus?</a>).</p>
          </div>
        </div>
        <div class="large-6">
          <div class="opaque-box">
            ...
            <p>Vaginal dilators are typically not effective when used without guidance. They should not be used without proper physical instruction, exercises, transitional steps, etc. Dilators are simply one aspect of the vaginismus treatment process, and <a href="/further-support/dilator-questions/can-i-just-get-dilators/index.php">if used without pelvic control techniques they will likely be very ineffective</a>. Involuntary muscle reactions are what produce the tightness and pain of vaginismus. The main focus of proper dilator use is in retraining the pelvic floor, not on stretching the vaginal opening.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="grad1">
      <h2>Visit Our Treatment FAQs Page</h2><a href="/further-support/treatment-questions/index.php">Learn More</a>
    </section>
    ...
    <?php
  $pagebacklink = '/treatment/index.php';
  $pageback = 'Treatment';
  $pageforwardlink = '/treatment/products/index.php';
  $pageforward = 'Products';
