...
<!--   MAIN SECTION   -->
        <section class="large-9">
          ...
          <h3>Veja Também</h3>
          <ul>
            <li><a href="../had-pleasurable-intercourse-before/index.html" target="_blank">Eu tinha intercurso sexual prazeroso antes e agora dói. Ainda assim, o meu problema pode ser vaginismo?</a></li>
...
<!--   SIDEBAR   -->
          ...
          <ul>
            ...
            <li><a href="../orgasms-problems-from-vaginismus/index.html" class="active"><i class="icon-angle-double-right"></i>Eu não consigo ter orgasmos. Isso pode estar relacionado ao vaginismo?</a></li>
          </ul>
