<?php
  $pagetitle = 'Eu não consigo ter orgasmos. Isso pode estar relacionado ao vaginismo?';
  $pagedescription = 'Eu não consigo ter orgasmos. Isso pode estar relacionado ao vaginismo? O vaginismo pode impedir o orgasmo em alguns casos.';
  $pagecanonical = 'https://www.vaginismus.com/por/faq/general-questions/orgasms-problems-from-vaginismus/';
...
<!--   MAIN SECTION   -->
        <section class="large-9">
          ...
          <h3>Veja Também</h3>
          <ul>
            <li><a href="/por/faq/general-questions/had-pleasurable-intercourse-before/index.php" target="_blank">Eu tinha intercurso sexual prazeroso antes e agora dói. Ainda assim, o meu problema pode ser vaginismo?</a></li>
            <li><a href="/por/faq/dilator-questions/dilators-treat-other-conditions/index.php">Os dilatadores podem ser usados para tratar outras disfunções além do vaginismo?</a></li>
            ...
            <li><a href="/por/vaginismus-symptoms/index.php">Sintomas do Vaginismo</a></li>
          </ul>
...
<!--   SIDEBAR   -->
          ...
          <ul>
            ...
            <li><a href="/por/faq/general-questions/orgasms-problems-from-vaginismus/index.php" class="active"><i class="icon-angle-double-right"></i>Eu não consigo ter orgasmos. Isso pode estar relacionado ao vaginismo?</a></li>
          </ul>
