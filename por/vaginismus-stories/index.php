<?php
  $pagetitle = 'Histórias sobre o Vaginismo';
  $pagedescription = 'As representações ficcionais de experiências reais do vaginismo para ajudar mulheres a determinar se elas têm a condição.';
  $pagecanonical = 'https://www.vaginismus.com/por/vaginismus-stories/';
...
<!--      HERO      -->
      ...
      <section class="hero-banner-image">
        <img src="../../img/por/stories-header-mobile-por.jpg" alt="vaginismus stories" class="hidden-desktop hidden-tablet" aria-hidden="true">
        <div class="wrapper">
           <div class="large-12 medium-12">
             <div class="hero-text">
               <h1>Histórias sobre o Vaginismo</h1>
               <h2>As representações ficcionais de experiências reais do vaginismo para ajudar mulheres a determinar se elas têm a condição.</h2>
               <p>Para descrições da vida real, veja <a href="../reviews/index.html">Comentários</a>.)</p>
             </div>
          </div>
        </div>
      </section>
...
<!--      PRE-FOOTER-NAV SECTION      -->
  ...
  <!--       NEEDS TO BE CONVERTED TO HTML RATHER THAN IMG-->
            <a href="../vaginismus-symptoms/index.html">
              <img src="../../img/por/stories-left-footer-button-por.png" alt="ir para a sintomas">
            </a>
          </div>
          <div class="large-6 medium-6">
  ...
  <!--       NEEDS TO BE CONVERTED TO HTML RATHER THAN IMG-->
             ...
             <a href="../vaginismus-causes/index.html">
               <img src="../../img/por/stories-right-footer-button-por.png" alt="ir para a causas">
             </a>
          </div>
        </div>
      </div>
