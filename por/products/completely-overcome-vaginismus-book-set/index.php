<?php
  $pagetitle = 'Programa de Tratamento em Casa';
  $pagedescription = 'Este abrangente de livro é bem ilustrado e contém mais de 300 páginas, detalhando o auto-tratamento profissional para o vaginismo. Ele cobre todos os aspectos do tratamento em casa bem sucedido em um formato passo a passo simples.';
  $pagecanonical = 'https://www.vaginismus.com/por/products/completely-overcome-vaginismus-book-set/';
...
<!--   HERO SECTION   -->
      <section class="hero grad1">
        <div class="wrapper">
          <h1>Programa de Tratamento em Casa</h1>
          <h3>Este abrangente de livro é bem ilustrado e contém mais de 300 páginas, detalhando o auto-tratamento profissional para o vaginismo. Ele cobre todos os aspectos do tratamento em casa bem sucedido em um formato passo a passo simples.</h3>
        </div>
      </section>
      ...
      <section class="product-description-0">
        <div class="wrapper">
          ...
          <div class="large-4 medium-4">
            <h2>Inclui:</h2>
            <ul>
              <li>Etapas fáceis de seguir</li>
              <li>Totalmente ilustrado</li>
              <li>Exercícios e Perguntas</li>
              <li>Inclui Passe para o Fórum</li>
            </ul>
...
<!--   ORDER TODAY SECTION   -->
      <section class="order-today">
        <div class="wrapper">
          <div class="large-4 medium-4">
            <h2>Encomende o Seu Livro Ainda Hoje!</h2>
