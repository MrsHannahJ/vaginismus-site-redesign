<?php
  $pagetitle = 'Historias del Vaginismo';
  $pagedescription = 'Dramatizaciones de experiencias reales para ayudar a las mujeres a determinar si tienen el padecimiento.';
  $pagecanonical = 'https://www.vaginismus.com/es/vaginismus-stories/';
...
<!--      HERO      -->
      ...
      <section class="hero-banner-image">
        <img src="../../img/es/stories-header-mobile-es.jpg" alt="Historias del Vaginismo" class="hidden-desktop hidden-tablet" aria-hidden="true">
        <div class="wrapper">
           <div class="large-12 medium-12">
             <div class="hero-text">
               <h1>Historias del Vaginismo</h1>
               <h2>Dramatizaciones de experiencias reales para ayudar a las mujeres a determinar si tienen el padecimiento.</h2>
               <p>(Para leer relatos de la vida real, vea <a href="../reviews/index.html">Comentarios</a>.)</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section class="has-v-background">
        <div class="wrapper">
          <div class="large-4">
            ...
            <h3>Ashley</h3>
            <h4>Problemas relacionados al dolor sexual a causa de endometriosis</h4>
            <p>“El sexo nunca ha sido muy cómodo para mí pero han habido ocasiones en las que ha sido mejor que otras. Tenía endometriosis y cuando recaía fuerte, el sexo dolía mucho. El doctor dijo que si se me hacía una histerectomía la endometriosis desaparecía y podría tener una vida más normal. Tuve la cirugía tres años atrás, pero aunque me siento bien y ya no queda cicatriz, la penetración o movimiento del pene causa ardor y dolor. No lo comprendo. No debería seguir teniendo problemas femeninos porque el problema fue extraído, sin embargo pareciera que mi vagina siempre se está contrayendo al intentar el coito. Mi esposo es muy paciente, pero ¿cuánto tiempo más podrá esperar? Él no se casó para esto. ¡Debe haber algo que yo pueda hacer!”</p>
          </div>
          <div class="large-4">
            <img src="../../img/stories/stories-tracey.jpg" alt="Tracey">
            <h3>Tracey</h3>
            <h4>Problemas después de cirugía</h4>
            <p>“Gozamos de una vida sexual  normal hasta que tuve complicaciones por una cirugía pélvica. Mucho después de que mi cuerpo sanara, mi esposo ya no podía lograr penetrarme. Era casi como tener una pared donde solía estar una abertura. Me dolía cada vez que tratábamos, a pesar de que los doctores afirmaban que no había ningún problema físico. Un especialista sugirió que podría tener vaginismo. ¿Se puede tratar esto o estaré destinada a vivir así para siempre?”</p>
          </div>
          <div class="large-4">
            <img src="../../img/stories/stories-desiree.jpg" alt="Desiree">
            <h3>Desiree</h3>
            <h4>Problemas después de violación</h4>
            <p>“Tengo 24 años de edad y nunca he estado casada. Sin embargo, he estado en algunas relaciones íntimas en las que disfruté mucho del sexo. Cuando tenía 22, salí con un patán que usó la fuerza y me violó al finalizar la noche. Aún recuerdo estar acostada ahí sintiéndome sucia y usada. Desde entonces, he salido con unos cuantos muchachos pero usualmente con miedo de acercarme mucho. Pero, hace tres meses conocí a alguien diferente; un hombre maravilloso de quien creo estar enamorada. Tratamos de tener relaciones unas pocas veces, pero me sorprendí de ver que simplemente no podía. No lo comprendo. El sexo estaba bien antes de que fuera atacada, pero ahora que conocí a alguien realmente especial, no parezco poder hacerlo. ¿Podría tener que ver con la violación?”</p>
          </div>
        </div>
      </section>
...
<!--      PRE-FOOTER-NAV SECTION      -->
  ...
  <!--       NEEDS TO BE CONVERTED TO HTML RATHER THAN IMG-->
            <a href="../vaginismus-symptoms/index.html">
              <img src="../../img/es/stories-left-footer-button-es.png" alt="Vinculo a Historias">
            </a>
          </div>
          <div class="large-6 medium-6">
  ...
  <!--       NEEDS TO BE CONVERTED TO HTML RATHER THAN IMG-->
             ...
             <a href="../vaginismus-causes/index.html">
               <img src="../../img/es/stories-right-footer-button-es.png" alt="Vinculo a  Causas">
             </a>
          </div>
        </div>
      </div>
