<?php
  $pagetitle = 'Soluciones Reales Para Dolor Sexual';
  $pagedescription = 'Ayudar a las mujeres a superar el sexo doloroso y estanqueidad con la intimidad con nuestro tratamiento dilatador vaginal casa.';
  $pagecanonical = 'https://www.vaginismus.com/es/';
...
<!--     HERO SECTION     -->
      ...
      <section id="hero" class="hero-banner-image">
        <img src="/img/es/home-header-mobile.jpg" class="hidden-desktop hidden-tablet" aria-hidden="true" alt="página principal">
        <div class="wrapper">
         <div class="large-12 medium-12">
           <div class="hero-text-right">
            <h1>Soluciones Reales Para</h1>
            <ul>
              <li><i class="icon-icon_check"></i>Dolor Sexual Continuo</li>
              <li><i class="icon-icon_check"></i>Parejas sin Consumar</li>
              <li><i class="icon-icon_check"></i>Constricción Vaginal o Ardor Durante el Sexo</li>
              <li><i class="icon-icon_check"></i>Dificultades de Penetración</li>
              <li><i class="icon-icon_check"></i>Dolor Sexual Relacionado a la Edad</li>
              <li><i class="icon-icon_check"></i>Dolor Después de la Cirugía</li>
          ...
          <div class="medium-6 large-4 hidden-tablet hidden-mobile">
             <div class="testimonial outer-shadow-dark">
               ...
               <div class="testimonial-text">
                 ...
                 <p>Sexólogos y autores reconocidos a nivel mundial</p>
               </div>
            </div>
          </div>
        </div>
