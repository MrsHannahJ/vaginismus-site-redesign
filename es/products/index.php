<?php
  $pagetitle = 'Productos';
  $pagedescription = 'los productos vendidos por vaginismus.com';
  $pagecanonical = 'https://www.vaginismus.com/es/products/';
...
<!--   MISSION BANNER   -->
     <section class="mission-banner grad1">
       <div class="wrapper">
         ...
         <p>Nuestra misión es la de ayudar a mujeres con vaginismo <em>en cualquier manera posible</em>. Trascendiendo los mejores programas de autoayuda, fomentamos ayuda y alentamos esperanza al brindar apoyo gratuito a mujeres en todo el mundo.in any way we can.</p>
       </div>
     </section>
