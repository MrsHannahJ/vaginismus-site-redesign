<?php
  $pagetitle = 'Set de Dilatadores Vaginales';
  $pagedescription = 'Simplemente un mejor producto: Estos dilatadores son suaves y cómodos, fáciles de controlar, livianos, libre de látex, lavables y seguros.';
  $pagecanonical = 'https://www.vaginismus.com/es/products/vaginal-dilator-set/';
...
<!--   HERO SECTION   -->
      <section class="hero grad1">
        <div class="wrapper">
          <h1>Set de Dilatadores Vaginales</h1>
          <h3>Simplemente un mejor producto: Estos dilatadores son suaves y cómodos, fáciles de controlar, livianos, libre de látex, lavables y seguros.</h3>
        </div>
      </section>
