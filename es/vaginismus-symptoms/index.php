<?php
  $pagetitle = 'Síntomas del Vaginismo';
  $pagedescription = 'Dependiendo de la intensidad, los síntomas del vaginismo varían desde leves sensaciones de ardor con constricción hasta el cierre total de la abertura de la vagina con penetración imposible.';
  $pagecanonical = 'https://www.vaginismus.com/es/vaginismus-symptoms/';
        ...
        <div class="wrapper">
           <div class="large-12 medium-12">
             ...
             <div class="hero-text-right">
               <h1>Síntomas del Vaginismo</h1>
               <h3>Dependiendo de la intensidad, los síntomas del vaginismo varían desde leves sensaciones de ardor con constricción hasta el cierre total de la abertura de la vagina con penetración imposible.</h3>
             </div>
          </div>
        </div>
      </section>
        ...
        <div class="wrapper">
          ...
          <div class="large-4 medium-6">
            ...
            <ul>
              ...
              <li>Evitación del sexo debido a dolor y/o fracaso</li>
            </ul>
          </div>
          <div class="large-4">
...
<!--      EXAMPLES OF EFFECTS SECTION      -->
      ...
      <section id="examples-effects">
        <h2>Ejemplos de los Efectos del Vaginismo</h2>
        <div class="wrapper">
        ...
        <div class="wrapper">
          ...
          <div class="large-8">
            <div class="opaque-box">
              <h2>Variaciones en la Experiencia del Vaginismo</h2>
              <p>El vaginismo se puede ser desencadenar en mujeres jóvenes como mayores; en mujeres sin experiencia sexual o con años de experiencia. No todas las mujeres experimentan el vaginismo de la misma manera, y su extensión varía:</p>
              <ul>
                <li>Algunas mujeres no son capaces de insertar absolutamente nada.</li>
                <li>Algunas mujeres son capaces de insertar un tampón y llevar a cabo un examen ginecológico completo pero no son capaces de aceptar la inserción del pene.</li>
                <li>Otras mujeres son capaces de tener una inserción parcial del pene aunque que este proceso sea muy doloroso.</li>
                <li>Algunas son capaces de aceptar la inserción completa del pene, pero la contracción e incomodidad interrumpen el avance normal de excitación al orgasmo y en su lugar trae dolor.</li>
                <li>Algunas mujeres son capaces de tolerar años de coito incómodo con dolor e incomodidad de gradual aumento que eventualmente interrumpen la experiencia sexual.</li>
                <li>Las mujeres también pueden experimentar años de esporádica dificultad con la penetración o el movimiento, y tienen que estar constantemente cuidando de controlar y relajar su área pélvica cuando ésta repentinamente ‘reacciona’.</li>
              </ul>
            </div>
          </div>
        </div>
...
<!--      PRIMARY & SECONDARY SECTION      -->
      ...
      <section class="has-v-background">
        <div class="wrapper">
          <div class="large-4 medium-6">
            <h2>Vaginismo Primario</h2>
            <p><strong>Cuando una mujer nunca ha podido tener actividad sexual sin dolor debido a la constricción causada por el vaginismo, su padecimiento se conoce como vaginismo primario.</strong></p>
            <p>El vaginismo primario es la experiencia de vaginismo durante los ‘primeros’ intentos de relación sexual. Típicamente, el vaginismo primario se descubre cuando una mujer intenta tener sexo por primera vez. El esposo / la pareja no es capaz de lograr la penetración y es como si se topara con una ‘pared’ en donde debería estar la abertura a la vagina. La penetración no es posible o es extremadamente difícil. Algunas mujeres con vaginismo primario también experimentan problemas con la inserción de un tampón o con los exámenes ginecológicos. Los músculos PC constriñen y contraen la abertura vaginal, haciendo la penetración incómoda o, en muchos casos, prácticamente imposible.</p>
            <div class="call-out">
              <p>El vaginismo primario es la causa frecuente de matrimonios sin relaciones sexuales, no consumados.</p>
            </div>
          </div>
          <div class="large-4 medium-6">
...
<!--      UNCONSUMMATED MARRIAGE SECTION      -->
      ...
      <section id="unconsummated-marriages">
        <h2>Matrimonios No Consumados y Penetración Imposible</h2>
        <h4>El vaginismo primario es la causa más frecuente de matrimonios no consumados.</h4>
        <div class="wrapper">
          <div class="large-4 medium-6">
            <p><strong>El vaginismo es la causa más común de matrimonios no consumados (donde el problema es causado por dificultades femeninas)</strong>. Las parejas con frecuencia describen sus intentos de coito como que hubiera una “pared” en donde debería estar la abertura vaginal. Algunas mujeres encuentran desconcertante cómo es que este padecimiento comenzó en ellas, cuando ellas no habían tenido contacto sexual previo ni problemas pélvicos. El coito es imposible y los dolorosos intentos de inserción refuerzan la respuesta del vaginismo. El reflejo (respuesta) condicionado persiste cada vez que existe la posibilidad de una penetración vaginal.</p>
            <p>Los músculos se rebelan, rehusando permitir la entrada, aunque la mujer realmente desee consumar y recibir a su esposo vaginalmente. El cuerpo no nace sabiendo cómo reaccionar al estímulo sexual. El coito exitoso se aprende a través de la experiencia y la interacción.</p>
          </div>
          <div class="large-4 medium-6">
            <p>El sistema nervioso y la musculatura descubren y recuerdan lo que se siente bien, lo que funciona, y lo que no es cómodo. Normalmente, la transición al coito se hace más placentera después de las primeras experiencias.</p>
            <p>Esto es extremadamente frustrante. Para el hombre excitado, es como topar con pared. Para la mujer, es como que su cuerpo ya no está bajo su control.</p>
            <p><strong>El sexo es una actividad sexual que involucra muchas respuestas condicionadas complejas.</strong></p>
            <p>La mente y el cuerpo permiten la penetración y aprenden a anticipar el coito positivamente. El resultado son mensajes positivos que generan excitación al anticipar la relación sexual. <strong> En una mujer con vaginismo primario, la mente y el cuerpo nunca tienen la oportunidad de entrenarse con experiencias sexuales positivas.</strong></p>
          </div>
          <div class="large-4">
            <p>El proceso de aprender a tener relaciones sexuales exitosas se trunca cuando los músculos vaginales entran en espasmo como reacción para protegerse del dolor. Con la ausencia de un control consciente directo por parte de la mujer, los nervios que controlan sus músculos vaginales reaccionan a la anticipación del coito con un llamado a contraerse apretadamente, a proteger y defender contra la amenaza del dolor ante una posible penetración.</p>
