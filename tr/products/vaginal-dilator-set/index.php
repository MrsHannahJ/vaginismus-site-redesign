<?php
  $pagetitle = 'Vajinal Dilatör Seti';
  $pagedescription = 'Kesinlikle daha iyi bir ürün: Bu dilatörler, pürüzsüz ve rahat, kontrolü kolay, hafif, latekssiz, yıkanabilir ve güvenlidirler.';
  $pagecanonical = 'https://www.vaginismus.com/tr/products/vaginal-dilator-set/';
...
<!--   HERO SECTION   -->
      <section class="hero grad1">
        <div class="wrapper">
          <h1>Vajinal Dilatör Seti</h1>
          <h3>Kesinlikle daha iyi bir ürün: Bu dilatörler, pürüzsüz ve rahat, kontrolü kolay, hafif, latekssiz, yıkanabilir ve güvenlidirler.</h3>
        </div>
      </section>
