<?php
  $pagetitle = 'Vajinismus Evde Tedavi Programı';
  $pagedescription = 'Vajinismusun profesyonel şekilde kendi kendine tedavi edilmesine dair 300 sayfalık, görsellerle zenginleştirilmiş kapsamlı bir bilgi kaynağı olan bu kitap, evde tedavinin başarılı şekilde gerçekleştirilebilmesi için adım adım talimatlar içerir.';
  $pagecanonical = 'https://www.vaginismus.com/tr/products/completely-overcome-vaginismus-book-set/';
...
<!--   HERO SECTION   -->
      <section class="hero grad1">
        <div class="wrapper">
          <h1>Vajinismus Evde Tedavi Programı</h1>
          <h3>Vajinismusun profesyonel şekilde kendi kendine tedavi edilmesine dair 300 sayfalık, görsellerle zenginleştirilmiş kapsamlı bir bilgi kaynağı olan bu kitap, evde tedavinin başarılı şekilde gerçekleştirilebilmesi için adım adım talimatlar içerir.</h3>
        </div>
      </section>
      ...
      <section class="product-description-0">
        <div class="wrapper">
          ...
          <div class="large-4 medium-4">
            <h2>Içerir:</h2>
            <ul>
              <li>Takibi Kolay Adımlar</li>
              <li>Tümü Görsellerle Desteklenmiş</li>
              <li>Egzersizler ve Sorular</li>
              <li>Forum Giriş hakkı içerir</li>
            </ul>
...
<!--   ORDER TODAY SECTION   -->
      <section class="order-today">
        <div class="wrapper">
          <div class="large-4 medium-4">
            <h2>Kitabınızın Siparişini Bugün Verin!</h2>
