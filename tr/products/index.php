<?php
  $pagetitle = 'Ürünleri';
  $pagedescription = 'vaginismus.com tarafından sunulan ürünler';
  $pagecanonical = 'https://www.vaginismus.com/tr/products/';
      ...
      <div class="wrapper">
         <div class="large-12 medium-12">
           <div class="hero-text-right">
             <h1 aria-hidden="true" class="visually-hidden">Vajinismus Ürünleri</h1>
...
<!--      VIDEO SECTION      -->
     ...
     <section class="mission-banner grad1">
       <div class="wrapper">
         <h2>Misyonumuz</h2>
         <p>Misyonumuz kadınları vajinismus konusunda  elimizden gelen  <em>her şekilde</em> desteklemektir. Birincil kendi kendine tedavi programımızın ötesine geçiyor ve dünya genelindeki kadınlara ücretsiz destek sağlayarak onlara yardım ediyor ve umut veriyoruz.</p>
       </div>
     </section>
