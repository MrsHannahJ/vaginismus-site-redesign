<?php
  $pagetitle = 'Cinsel ağrı için gerçek çözümler';
  $pagedescription = 'Kaynaklarla kadınlara yardım eden evde tedavi programı ile samimiyeti ile vajinismus, ağrılı cinsel, penetrasyon zorlukları ve gerginlik üstesinden gelmek için.';
  $pagecanonical = 'https://www.vaginismus.com/tr/';
        ...
        <div class="wrapper">
         <div class="large-12 medium-12">
           <div class="hero-text-right">
            <h1>Gerçek Çözümler:</h1>
            <ul>
              <li><i class="icon-icon_check"></i>Devamlı Acı Veren Seks</li>
              <li><i class="icon-icon_check"></i>Evlilikleri Cinsel Birleşmeyle Tamamlanmayan Çiftler</li>
              <li><i class="icon-icon_check"></i>Vajinal DarIık/Seks Sırasında Yanma</li>
              <li><i class="icon-icon_check"></i>Giriş Zorlukları</li>
              <li><i class="icon-icon_check"></i>Yaşla İlgili Cinsel Acı</li>
              <li><i class="icon-icon_check"></i>Ameliyat ya da Doğumdan Sonra Acı</li>
            </ul>
            </div>
          </div>
        </div>
          ...
          <div class="medium-6 large-4">
             <div class="testimonial outer-shadow-dark">
               ...
               <div class="testimonial-text">
                 ...
                 <p>Ottowa Üniversitesi, İnsan Psikolojisi Laboratuarı</p>
              </div>
            </div>
          </div>
             ...
             <div class="testimonial outer-shadow-dark">
              <img src="/img/icons/quotations.png" alt="" aria-hidden="true" class="quotes">
                <div class="testimonial-text">
                  ...
                  <p>Amerikan Fizik Tedavi Birliği, Kadın Sağlığı Fizik Terapi Dergisi</p>
                </div>
            </div>
          </div>
          ...
          <div class="medium-6 large-4 hidden-tablet hidden-mobile">
             <div class="testimonial outer-shadow-dark">
               ...
               <div class="testimonial-text">
                 ...
                 <p>Dünyaca ünlü seks terapistleri ve yazarları</p>
               </div>
            </div>
          </div>
        </div>
