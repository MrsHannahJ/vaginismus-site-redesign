<?php
  $pagetitle = 'Çocuk doğurmak vajinismusa neden olabilir mi? Vajinismus engellenebilir mi?';
  $pagedescription = 'Kadınlar doğumdan sonra devam eden cinsel acı, yanma, sıkılık, rahatsızlık ya da giriş zorlukları yaşadıklarında bu tipik olarak vajinismustur.';
  $pagecanonical = 'https://www.vaginismus.com/tr/faq/pregnancy-questions/can-childbirth-cause-vaginismus/';
...
<!--   MAIN SECTION   -->
        <section class="large-9">
          <h1>Çocuk doğurmak vajinismusa neden olabilir mi? Vajinismus engellenebilir mi?</h1>
          ...
          <ul>
            <li>Doğumdan sonra potansiyel duygusal sarsıntıyı azaltmak için doğum süreci konusundaki korkulara gerçeklerle karşılık verin. Korku ya da endişeleri ebeler, hemşireler ya da doktorlarla görüşün. Doğum süreci hakkında kendinizi eğitip bilgi sahibi olun.</li>
            <li>Dengesiz endişeler ya da “acı beklentisi” korkularını azaltmak için zorlu doğum hikâyelerini dinlemeyin ve onlara odaklanmayın. Çoğu kadın olumlu doğum deneyimi yaşar. Eğer doğum ağrıları sizi çok korkutuyorsa, istemeniz hâlinde epidurallar ve başka ağrı geçirme müdahalelerin de var olduğunu unutmayın. Doktorunuzla eğer gerekli olursa acıyla başa çıkma stratejilerine hazırlıklı olma konusunda danışın.</li>
            <li>Olumlu bir kafa yapısı ve tutumu koruyun. “Kadınlar her gün doğum yapıyorlar” ve “Eğer onlar yapabiliyorsa, ben de yapabilirim!” şeklindeki düşünceler olumsuz düşünceleri gidermeye yardımcı olur.</li>
            <li>Doktor başka türlü tavsiye etmemişse, hamilelik boyunca sekse devam edin.</li>
            <li>Doğumdan sonra, çoğu doktorun tavsiye ettiği gibi cinsel birleşmeye başlamadan önce altı hafta bekleyin. Bu önemlidir, çünkü vajinal kanalın iyileşmesine izin verir ve böylece doğumdan sonra cinsel birleşmeye geçerken ilk önce fiziksel acı hissedilmez.</li>
            <li>Yavaş yavaş ilerleyin, doğumdan sonra ilk kez yapılan seks yavaş hareketlerle ve rahat bir şekilde gerçekleşmelidir.</li>
            <li>Hamilelikten sonra özellikle de emzirirken sık sık hormonsal değişiklikler gerçekleşip vajinal kuruluğa neden olabileceğinden bol bol kayganlaştırıcı kullanın.</li>
            <li>Eğer seks öncesinden daha farklı görünürse şaşırmayın. Anne olmanın taleplerinin oluşturduğu duygusal stres ve yorgunluğun yanı sıra hormon değişiklikleri bir kadına kendini seksi hissettirmeyebilir. Ayrıca, anne olmaktan sevgili olmaya geçiş de bazı değişiklikler gerektirebilir.</li>
            <li>Vajinismus tetiklenmesinden uzak durmak için doğum sonrası pelvik acı olursa derhal bir doktora görünün. Uzun vadeli etkisi olmadan kolayca çözümlenecek olan bir enfeksiyon ya da başka bir sorun olabilir.</li>
          </ul>
