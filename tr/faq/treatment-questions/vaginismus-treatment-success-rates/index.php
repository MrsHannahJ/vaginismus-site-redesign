<?php
  $pagetitle = 'Vajinismus tedavisi ne kadar başarılı oluyor?';
  $pagedescription = 'Vajinismus tedavisi ne kadar başarılı oluyor? Vajinismusun tedavi oranı çok yüksektir. Dinamik bir program izlendiğinde, tedavi sonuçları hemen hemen her zaman tam bir çözümlenmeyle olumlu ve başarılıdır.';
  $pagecanonical = 'https://www.vaginismus.com/tr/faq/treatment-questions/vaginismus-treatment-success-rates/';
...
<!--   MAIN SECTION   -->
        <section class="large-9">
          <h1>Vajinismus tedavisi ne kadar başarılı oluyor?</h1>
               
          <h3>Vajinismusun tedavi oranı çok yüksektir.</h3>
          <p>Dinamik bir program izlendiğinde, tedavi sonuçları hemen hemen her zaman tam bir çözümlenmeyle olumlu ve başarılıdır.</p>
          <table>
            
            <thead>
             <tr>
               <th colspan="2">Vajinismus Tedavisi Başarı Oranları</th>
             </tr>
             <tr>
                <th>Oran</th>
                <th>Bağımsız Araştırma Aktarılmıştır</th>
             </tr>
            </thead>
            <tbody>
              ...
              <tr>
                <td>97.7%</td>
                <td>Schnyder, Schnyder-Luthi, Ballinari ve Blaser, 1998 <sup>7</sup></td>
              </tr>
              <tr>
                <td>95%</td>
              ...
              <tr>
                <td>75-100%</td>
                <td>Heiman’da aktarılan araştırmalar, 2002 <sup>3</sup></td>
              </tr>
            </tbody>
          </table>
