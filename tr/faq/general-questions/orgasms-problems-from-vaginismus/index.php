...
<!--   MAIN SECTION   -->
        <section class="large-9">
          ...
          <p>Orgazm zorluğu yaşanmasının birçok nedeni olduğu için orgazm sorunlarına sistematik bir yaklaşım yararlıdır.  Kadınlar orgazm konusundaki zorluklarının tam olarak ne olduğunu belirlemeye, duygularla mı, endişe, fiziksel acı ya da ilaç kullanımıyla mı alakalı olduğunu bulmaya teşvik edilirler.  Vajinismus programının Adım 2’sinde yer alan <a href="/tr/products/vaginismus-treatment-kit/index.php">kendine yardım</a> cinsel tarihçe envanteri, soruna katkıda bulunabilen belirli bazı cinsel korku ya da duyguların tanımlanmasına yardımcı olabilir.</p>
          ...
          <h3>Ayrıca Bkz</h3>
          <ul>
            <li><a href="/tr/faq/general-questions/had-pleasurable-intercourse-before/index.php" target="_blank">Daha önce zevk veren cinsel birleşmede bulunabildiysek ve şimdi canım acıyorsa sorunum hâlâ vajinismus olabilir mi?</a></li>
            <li><a href="/tr/faq/dilator-questions/dilators-treat-other-conditions/index.php">Dilatörler vajinismustan başka sorunları tedavi etmekte de kullanılabilir mi?</a></li>
...
<!--   SIDEBAR   -->
          ...
          <ul>
            ...
            <li><a href="/tr/faq/general-questions/orgasms-problems-from-vaginismus/index.php" class="active"><i class="icon-angle-double-right"></i>Orgazm olamıyorum. Bu durum vajinismusla ilgili olabilir mi?</a></li>
          </ul>
