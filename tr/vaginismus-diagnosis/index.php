<?php
  $pagetitle = 'Teşhis ve Testleri';
  $pagedescription = 'Tıbbi teşhis, tipik olarak hastanın tıbbi geçmişine bakılıp başka sorunların olmadığından emin olmak için yapılan jinekolojik muayene sonrasında konulur.';
  $pagecanonical = 'https://www.vaginismus.com/tr/vaginismus-diagnosis/';
      ...
      <section class="hero-banner-image">
        ...
        <div class="wrapper">
           <div class="large-12 medium-12">
             <div class="hero-text">
               <h1>Teşhis ve Testleri</h1>
               <h2>Tıbbi teşhis, tipik olarak hastanın tıbbi geçmişine bakılıp başka sorunların olmadığından emin olmak için yapılan jinekolojik muayene sonrasında konulur.</h2>
             </div>
          </div>
        </div>
      </section>
...
<section class="has-v-background">
  <div class="wrapper">
    <h2>Vajinismusun Tıbbi Teşhisi</h2>
    <div class="large-4">
      <p>Kadınlar genelde belirtilerine bakarak vajinismusları olup olmadığından şüphelenirler ama tıbbi onay almak zor olabilir. Vajinismus konusunda resmî bir teşhisin onaylanması planlama ve sabır gerektirebilir. Vajinismusun teşhis edilmesi için kesin bir tıbbi teşhis olmadığından, tıbbi bir teşhisin konulabilmesinden önce birkaç doktor ya da uzmana gidilmesi gerekebilir.</p>
      <p>Doktorlar ilk önce belirli bir tıbbi sorun bulamadıklarında (ki vajinismus rahatsızlığı çekenlerin sıklıkla yaşadıkları bir durumdur) ilk yapılan tıbbi muayenelerin sonucu genellikle teşhis konulamaması ya da yanlış teşhis konulması olur.</p>
      <div class="call-out">
        <p>Kadınların kendilerini kuvvetli bir şekilde savunmaları ve bilgili bir profesyonelden, başka bir sorun olmadığından emin olarak vajinismus teşhisini doğru olarak koyması konusunda ısrar etmeleri gerekebilir.</p>
      </div>
    ...
    <div class="large-4">
      ...
      <ul>
        ...
        <li><strong>Fizik Tedavi Uzmanları</strong> &#8211; Gitgide artan sayıda fizik tedavi uzmanı vajinismus gibi pelvik taban ve cinsel acı sorunları konularında uzmanlık yapmaktadır. Birçok fizik tedavi uzmanı, kadınların evlerinde, kendi hızlarında ve daha düşük bir giderle çalışabilmesine imkân veren ev programları oluşturmakta hastalarla birlikte çalışır. Amerikan Fizik Tedavisi Derneği Journal of Women’s Health Physical Therapy kısa bir süre önce vajinismusu olan bütün kadınların bizim kaynaklarımızı kullanmalarına yönelik bir tavsiye yayınladı. Birçok tedavi uzmanı, hastalarına başarılı ev tedavisinde yol göstermek için kaynaklarımızı kullanıyor.</li>
        <li><strong>Seks Terapistleri, Psikologlar ve Danışmanlar</strong> &#8211; Vajinismus konusunda çeşitli derecelerde deneyim sahibi olan daha başka birçok uzman da bulunmaktadır.</li>
      </ul>
    </div>
  </div>
</section>
<section id="pelvicexam" class="grad1">
  <h2>Vajinismus Teşhisinin bir Parçası Olarak Pelvik Muayene</h2>
  <div class="wrapper">
    <div class="large-6 medium-6">
      <p>Vajinismus teşhisinin en önemli yönlerinden biri, belirtilere sebep olabilecek diğer olas fiziksel veya tıbbi durumların ayrıntılı şekilde elenmesi ve vajinismusu neredeyse kesin sebep olarak öne çıkarmasıdır.</p>
      <p><strong>Eleme süreci, vajinismus teşhisinin önemli bir parçasıdır.</strong> Teşhis süreci tıbbi ve cinsel geçmişe dair bilgi verilmesini ve pelvik veya jinekolojik muayene yapılmasını içerir.</p>
    </div>
    <div class="large-6 medium-6">
      <p>Doktor, doğru bir vajinismus teşhisi koyabilmek için acının yerini ve gerçekleşme şeklini öğrenmek isteyebilir ve vajinismusun yanında başka sorunların elenmesini sağlayacak başka testler de rica edebilir.</p>
      <p>Bazı kadınlar, kendilerini ifade etme ve muayene olma konusunda kadın sağlık uzmanlarıyla çalışırlarsa daha rahat hissetmektedirler. Bunun önemli bir husus olması hâlinde, kadınların bir kadın uzmana yönlendirilmelerini tavsiye ediyoruz. Etkin ve sistemli bir yaklaşım benimsemek, kişinin daha iyi bakım ve tedavi sonuçları almasını sağlar.</p>
    </div>
  </div>
</section>
<section>
  <h2>Vajinismus Teşhisine Özgü Zorluklar</h2>
  <div class="wrapper">
    <div class="large-4">
      <p><strong>Yanma, sıkılık ve zor giriş gibi belirtiler pelvik muayene sırasında hiç fark edilmeyebilir. </strong>Bazı kadınlar için bu belirtiler sadece cinsel birleşme çabaları sırasında gerçekleşir. Bu nedenle, teşhiste bulunurken kadının üstü kapalı bir şekilde “Cinsel birleşme sırasında zorluk çekiyorum” gibi bir söz söylemesine bile ciddi bir önem verilmelidir.</p>
      <p>Bazen, yoğun çalışan sağlık uzmanları vajinismus belirtilerini anlamaz ve sadece “daha çok kayganlaştırıcı kullanın”, “daha çok gevşemeye çalışın” ya da “biraz şarap için” gibi standart (ama yardımı dokunmayan) öğütler verirler. Bunun nedeni vajinismus konusunda fazla bilgileri olmaması ya da konu hakkında güncelliği geçmiş yayınlardan edindikleri bilgilerle hareket etmeleridir. Vajinismusu olan bazı kadınlar PC kas sıkılığından ötürü, jinekolojik muayeneleri aşırı acı verici bulurlar ve muayeneye tahammül edemezler. Eğer bir kadın bir muayeneyi tamamlamakta zorluk çekeceğini düşünüyorsa, bunu doktoruna bildirmelidir.</p>
      <div class="call-out">
        <p>Vajinismüsü iyileştirecek bir ameliyat yoktur. Vajinal açıklığı 'genişletmek' için ameliyat önerildiyse ikinci bir görüş olmak çok önemlidir çünkü bü genelde giriş sorununu çözümlemek yerine sorüna daha fazla komplikasyon getirir.</p>
      </div>
  ...
  <section id="samplescript">
    <div class="wrapper">
      <h2>Örnek Senaryo: Kendi Kendine Oluşturulan Bir Cinsel Acı Tarihçesi</h2>
      <h4>Aşağıdaki örnek senaryo, kadınların cinsel acılarına güvenilir bir teşhis alabilmelerine yardım etmek için doktor muayenelerine hazırlanmaları üzere yararlı ipuçları içerir. Metin, vajinismus durumuyla bağlantılı olan örnekler sağlar, ancak herhangi bir cinsel ya da pelvik acı sorununun ayrıntılarını bildirmek için kolayca değiştirilebilir:</h4>
      <div class="large-4">
        <p><strong>1. Sorunu Bildirin</strong><br /> “Seks sırasında sorunlar yaşıyorum ve bana yardım edebileceğinizi ümit ediyorum.”</p>
        <p><strong>2. Acıyı Tanımlayın (Kesin Konuşun)</strong><br /> Şöyle Olduğunda Oluyor… “kocam penisini vajinama sokmaya çalıştığında” ya da “içime girdikten sonra hareket etmeye başladığında yanma ve sıkışma hissediyorum,” vb.</p>
        <p>Acı Surada… “vajinamın girişinde. Vajinam bir duvar gibi; eşim içime giremiyor” ya da “eşim içime girdikten sonra penisin girişten hemen sonra bulunduğu yerde yanma hissediyorum,” vb.</p>
        <p>Acı şu kadar devam ediyor… “Eşim cinsel birleşme çabasına devam ettikçe, özellikle de penisini zorla sokmaya çalışırsak. Buna son verdiğinde acı yok oluyor.”</p>
      </div>
      <div class="large-4">
        <p>Bu ne zamandır devam ediyor… “İki yıl önceki balayımızdan beri ve seks yapmaya çalıştığımız her seferinde devam etti” (birincil vajinismus) ya da “sekiz ay önce rahmimin alınmasından beri” (ikincil vajinismus), vb.</p>
        <p>Nasıl hissettiriyor… “yanma”, “batma”, “eşim bir duvara vuruyormuş gibi oluyor”, “giriş sırasında ya da hemen sonra daralma”, vb.</p>
        <p>Acıyı azaltmak ya da ortadan kaldırmak için şunları yaptım… “kayganlaştırıcı kullandım, seks pozisyonlarımızı değiştirdik, daha çok gevşemeye çalıştım.”</p>
        <p>Şunları Yapabiliyorum/Yapamıyorum… “tampon koymak ya da jinekolojik bir muayeneyi tamamlamak.”</p>
      </div>
      <div class="large-4">
    ...
    <div class="wrapper center">
      <p>Not: Daha önce acı duymadan cinsel ilişkide bulunabildiyseniz bunu doktorunuza bildirin.</p>
    </div>
