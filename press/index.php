...
?>
    ...
    <main class="press">
      <div class="wrapper">
<!--   MAIN SECTION   -->
        <section id="press-menu">
          <h1>Press Reviews</h1>
          <div class="outer-shadow">
            <a href="#press-shelly">
              <h2 class="article-title"><em>Product News &amp; Reviews &#8211; Complete Vaginismus Treatment Kit</em> &#8211; by B. Shelly, PT, BCIA-PMDB,  APTA Journal of Women’s Health Physical Therapy</h2>
              <p class="article-preview hidden-mobile">In the winter 2005 edition of the APTA (American Physical Therapy Association) Journal of Women&#8217;s Health Physical Therapy, author Beth Shelly, PT, BCIA-PMDB and editor Donna Edwards, PT, OCS published an unsolicited and detailed review of vaginismus.com&#8217;s...
              </p>
              <p>Read More<i class="icon-angle-double-right"></i></p>
              
            </a>
          </div>
          <div>
            <a href="#press-maya">
              <h2 class="article-title"><em>Completely Overcome Vaginismus</em> &#8211; Reviewed by Maya Bat-Ami, Psy.D</h2>
              <p class="article-preview hidden-mobile">The intent of the book is to provide a self-help program for women suffering from vaginismus...</p>
              <p>Read More<i class="icon-angle-double-right"></i></p>
            </a>
          </div>
          <div>
            <a href="#press-rae">
              <h2 class="article-title">&#8220;Clampdown&#8221;, K. Rae, <em>Glow</em> Magazine</h2>
              <p class="article-preview hidden-mobile">&#8220;Clampdown&#8221; is a well-developed article, mostly about primary vaginismus, that was published in the May&#8260;June 2007 issue of Glow magazine.</p>
              <p>Read More<i class="icon-angle-double-right"></i></p>
            </a>
          </div>
          <div>
            <a href="#press-cardwell">
              <h2 class="article-title">&#8220;When Sex Hurts&#8221;, Kate Cardwell, <em>Today's Christian Woman</em></h2>
              <p class="article-preview hidden-mobile">In this article, published in the Nov/Dec 2004 issue of Today’s Christian Woman Kate Cardwell relates her experience with painful intercourse and the impacts to her marriage. Kate served as a moderator in our Vaginismus.com private forum for many years.</p>
              <p>Read More<i class="icon-angle-double-right"></i></p>
            </a>
          </div>
          <div>
            <a href="#press-mears">
              <h2 class="article-title">&#8220;When Sex is a Pain&#8221;, Jo Mears, <em>Bella</em> Magazine</h2>
              <p class="article-preview hidden-mobile">Published in the popular UK magazine Bella, this article references an interview with Kayleigh Morris, just one of the many women who have completed a vaginismus recovery program offered through vaginismus.com.</p>
              <p>Read More<i class="icon-angle-double-right"></i></p>
            </a>
          </div>
          <div>
            <a href="#press-wider">
              <h2 class="article-title">&#8220;Why Sex Sometimes Hurts&#8221;, J. Wider, <em>Cosmopolitan</em></h2>
              <p class="article-preview hidden-mobile">The following excerpt about vaginismus was published in the August 2007 edition of Cosmopolitan magazine following an interview with vaginismus.com.</p>
              <p>Read More<i class="icon-angle-double-right"></i></p>
            </a>
          </div>
         
        </section>
        <section class="article" id="press-shelly">
          <hr />
          ...
          <p>&#8220;The set comes with a universal handle that easily attaches to the dilator end … and easily inserted by patients. Appropriate, easy-to-follow written instructions are also included … effective and priced well.&#8221;</p>
          ...
          <p>&#8220;Step 3 shows self discovery techniques and describes anatomy. The workbook has unlabeled pictures to test knowledge. The pelvic floor muscle (PFM) is introduced in step 4 … In step 5 the patient is guided in insertion … Step 6 progresses.&#8221;</p>
          <p>&#8220;Clear instructions are given with gradual insertion … Many ideas for trouble shooting insertion are given … Advancing dilator sizes is discussed. Step 7 involved sensate exercises … Gradually getting comfortable with each other is explained. In step 8 … Sensate exercises are then practiced … with attention to keeping the PFM relaxed.&#8221;</p>
          <p>&#8220;Step 9 explains the transition to intercourse with partial insertion and the female on top. Clear pictures show the anatomy of insertion. Many suggestions are given for making insertion successful. Step 10 progresses to movement during penetration and other pleasurable components of intercourse. Appendix C gives program rationale and effectiveness including citation of 8 references with outcomes data.&#8221;</p>
        ...
        <section class="article" id="press-maya">
         <hr/>
          <h2>Review of <em>Completely Overcome Vaginismus &#8211; The Practical Approach to Pain-Free Intercourse</em> by Mark and Lisa Carter<br />by Maya Bat-Ami, Psy.D</h2>
        ...
        <section class="article" id="press-rae">
          <hr/>
          <h2>&#8220;Clampdown&#8221;,  K. Rae, Glow Magazine</h2>
            
            <p>The fittingly named article, &#8220;Clampdown&#8221;, was published in the May/June 2007 issue of Glow magazine. This well-developed article focused on primary vaginismus.</p>
            ...
            <p>&#8220;Once a woman feels more in control of her muscles, the next step is to dilate the vagina to desensitize it … there are vaginal dilator kits available for sale … available at <strong>vaginismus.com</strong>&#8221;</p>
            <h3>Reference</h3>
            <ol>
        ...
        <section class="article" id="press-cardwell">
          <hr />
          <h2>&#8220;When Sex Hurts&#8221; by Kate Cardwell</h2>
                  
          <p><em>In this article, published in the Nov/Dec 2004 issue of <em>Today’s Christian Woman</em> Kate Cardwell relates her experience with painful intercourse and the impacts to her marriage. Kate served as a moderator in our Vaginismus.com private forum for many years.</em></p>
          ...
          <p>When my physician examined me, he found nothing physically wrong and said the pain should subside. But it didn&#8217;t. In fact, it got worse. I didn&#8217;t know what was happening, and fear kept me from telling Brian for two years. Many times I hid the tears. I thought if I told him, he&#8217;d be afraid to touch...</p>
          <a href="http://www.todayschristianwoman.com/articles/2004/november/13.62.html" target="_blank">Read Full Article at http://www.todayschristianwoman.com »</a>
          <h3>Reference</h3>
          <ol>
        ...
        <section class="article" id="press-mears">
          <hr />
          <h2>&#8220;When SEX is a pain &#8221;, Jo Mears, <em>Bella</em> Magazine</h2>
                  
          <p>Published in the popular UK magazine <em>Bella</em>, this article references an interview with Kayleigh Morris, just one of the many women who have completed a vaginismus recovery program offered through vaginismus.com:</p>
          <p>Thousands of women suffer agony if they try to make love or even use a tampon. A simple treatment programme could change their lives.</p>
        ...
        <section class="article" id="press-wider">
          <hr />
          <h2>Article about Vaginismus in Cosmopolitan</h2>
