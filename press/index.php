    ...
    <section id="hero-english">
      <div class="wrapper">
        <div class="large-8 medium-8">
          <h1>Press Reviews</h1>
          <p>Vaginismus.com has been featured in and reviewed by various <a href="/further-support/professional-assistance/medical-specialist-reviews/index.php">specialists</a> and publications. Select issues are included below.</p>
          <p>For media requests <a href="/contact-us/index.php">contact us</a>.</p>
        </div>
      </div>
    </section>
    <div class="wrapper">
      ...
      <section class="box" id="press-section">
        ...
        <div class="wrapper">
          ...
          <div class="large-6 medium-6">
            ...
            <h3>Cosmopolitan Magazine<br/>J. Wider</h3>
            <p>The following excerpt about vaginismus was published in the August 2007 edition of Cosmopolitan magazine following an interview with vaginismus.com.</p>
            <button class="gray-btn togglePressArticle">Read Full Article</button>
          </div>
        </div>
        <div class="article bottom" id="press-wider">
          <hr />
          <!--
...
-->
      ...
      <section class="box" id="press-section">
        ...
        <div class="wrapper">
          ...
          <div class="large-6 medium-6">
            ...
            <h3><em>Today's Christian Woman</em><br/>Kate Cardwell</h3>
            <p>In this article, published in the Nov/Dec 2004 issue of Today’s Christian Woman Kate Cardwell relates her experience with painful intercourse and the impacts to her marriage. Kate served as a moderator in our Vaginismus.com private forum for many years.</p>
            <button class="gray-btn togglePressArticle">Read Full Article</button>
          </div>
        </div>
        <div class="article bottom" id="press-cardwell">
          <hr />
          <h3>&#8220;When Sex Hurts</h3>
      ...
      <section class="box" id="press-section">
        ...
        <div class="wrapper">
          ...
          <div class="large-6 medium-6">
            ...
            <h3>Bella Magazine<br/>Jo Mears</h3>
            <p>Published in the popular UK magazine Bella, this article references an interview with Kayleigh Morris, just one of the many women who have completed a vaginismus recovery program offered through vaginismus.com.</p>
            <button class="gray-btn togglePressArticle">Read Full Article</button>
          </div>
        </div>
        <div class="article bottom" id="press-mears">
          <hr />
          <h3>&#8220;When SEX is a pain</h3>
      ...
      <section class="box" id="press-section">
        ...
        <div class="wrapper">
          ...
          <div class="large-6 medium-6">
            ...
            <h3>APTA Journal of Women’s Health Physical Therapy<br/>by B. Shelly, PT, BCIA-PMDB</h3>
            <p>In the winter 2005 edition of the APTA (American Physical Therapy Association) Journal of Women&#8217;s Health Physical Therapy, author Beth Shelly, PT, BCIA-PMDB and editor Donna Edwards, PT, OCS published an unsolicited and detailed review of vaginismus.com&#8217;s...</p>
            <button class="gray-btn togglePressArticle">Read Full Article</button>
          </div>
        </div>
        <div class="article bottom" id="press-shelly">
          <hr />
          <h3>APTA Journal of Women&#8217;s Health Physical Therapy</h3>
      ...
      <section class="box" id="press-section">
        ...
        <div class="wrapper">
          ...
          <div class="large-6 medium-6">
            ...
            <h3>Glow Magazine<br/>K. Rae</h3>
            <p>&#8220;Clampdown&#8221; is a well-developed article, mostly about primary vaginismus, that was published in the May&#8260;June 2007 issue of Glow magazine.</p>
            <button class="gray-btn togglePressArticle">Read Full Article</button>
          </div>
        </div>
        <div class="article bottom" id="press-rae">
          <hr/>
          <h3>&#8220;Clampdown&#8221;</h3>
      ...
      <section class="box" id="press-section">
        ...
        <div class="wrapper">
          ...
          <div class="large-6 medium-6">
            <h2 class="hidden-mobile">Review of <em>Completely Overcome Vaginismus – The Practical Approach to Pain-Free Intercourse</em> by Mark and Lisa Carter</h2>
            <h3>by Maya Bat-Ami, Psy.D</h3>
            <p>The intent of the book is to provide a self-help program for women suffering from vaginismus. The book can be read alone but also can be purchased as part of a kit which includes; a companion workbook, a set of vaginal dilators, a video, and a password...</p>
            <button class="gray-btn togglePressArticle">Read Full Article</button>
          </div>
        </div>
        <div class="article bottom" id="press-maya">
          <hr/>
          <h3>Review of <em>Completely Overcome Vaginismus &#8211; The Practical Approach to Pain-Free Intercourse</em> by Mark and Lisa Carter</h3>
