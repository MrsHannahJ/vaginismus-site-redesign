<!--   SIDEBAR   -->
        ...
        <aside class="large-3">
          ...
          <ul>
            ...
            <li>
              <a href='/further-support/dilator-questions/what-are-the-dilators-made-of/index.php' <?php
              if ($active == 'made') {
                echo 'class="active"';}
              ?>> <i class="icon-angle-double-right"></i>What are the dilators made of?</a>
            </li>
            <li><a href='/further-support/dilator-questions/dilators-treat-other-conditions/index.php' <?php if($active == 'other') {echo 'class="active"';} ?>><i class="icon-angle-double-right"></i>Can the dilators be used to treat other conditions besides vaginismus?</a></li>
            <li><a href='/further-support/dilator-questions/will-dilators-break-hymen/index.php' <?php if($active == 'hymen') {echo 'class="active"';} ?>><i class="icon-angle-double-right"></i>If my hymen is still intact, will using the dilators break it and will this hurt?</a></li>
