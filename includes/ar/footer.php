...
<nav class="footer-nav">
  ...
  <div class="tab large-3 medium-3">
    ...
    <label for="footer-label-3">التنزيلات</label>
    <div class="footer-label-content">
      <ul>
        <li><a href="/downloads/vaginismus_brochure-ar.pdf">نشرة التشنج المهبلي</a></li>
        <li><a href="/downloads/dilator_brochure-ar.pdf">نشرة الموسعات</a></li>
        <li><a href="/downloads/sample-script-a-self-guided-history-of-sexual-pain-ar.pdf">النصي التشخيص</a></li>
      </ul>
    </div>
  </div>
  <div class="tab large-3 medium-3">
    <input id="footer-label-4" type="radio" name="tabs2">
    <label for="footer-label-4"><img src="/img/iraq.png" alt="اللغات" aria-hidden="true">اللغات</label>
    <div class="footer-label-content">
      <ul>
...
-->
      ...
      <div id="footer-badges" class="wrapper">
        <div class="social-container">
          <ul>
            <li><a href="https://www.facebook.com/womenshealthrs/" target="_blank"><img src="/img/facebook.jpg" alt="تابعنا في الفيسبوك"></a></li>
            <li><a href="https://twitter.com/VaginismusCom" target="_blank"><img src="/img/twitter.png" alt="تابعنا على تويتر"></a></li>
            <li><a href="https://plus.google.com/+Vaginismuscom/" target="_blank"><img src="/img/google-plus.png" alt="تابعنا على Google+"></a></li>
            <li><a href="http://pinterest.com/VaginismusCom" target="_blank"><img src="/img/pinterest.png" alt="تابعنا على موقع Pinterest"></a></li>
            <li><a href="http://instagram.com/VaginismusCom" target="_blank"><img src="/img/instagram.png" alt="تابعنا على موقع Instagram"></a></li>
          </ul>
        </div>
        <div id="copyright">
          <p>يتم تقديم جميع المعلومات المقدمة على vaginismus.com لأغراض تعليمية فقط وليس المقصود أن يكون بديلا عن المشورة الطبية المهنية.   &nbsp;دائما استشارة الطبيب المعالج بشأن إمكانية تطبيق أي معلومات عن هذا الموقع فيما يتعلق الأعراض أو الحالات الطبية. <br>&copy; 1999 - <?php echo date("Y");?>, Vaginismus.com. كل الحقوق محفوظة.</p>
        </div>
      </div>
